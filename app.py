...
# 1. CONFIGURAÇÃO DE CAMINHOS (Corrigido para o Render)
...
# --- COMANDO CRUCIAL PARA O RENDER ---
# Isso força a criação do banco de dados antes do app começar a rodar
...
def login():
    if request.method == 'POST':
        ...
        return "Erro: Credenciais inválidas. <a href='/login'>Voltar</a>"
...
def tela_solicitar():
    ...
    return render_template('solicitar.html', labs=["Informática", "Redes", "Robótica"], nome=session.get('nome'))
